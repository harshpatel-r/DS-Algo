...
write as many letters on the first line such that the total width does not exceed 100 pixels. Then, from where you stopped in
s, continue writing as many letters as you can on the second line. Continue this process until you have written all of s.
...
var numberOfLines = function (widths, s) {
    ...
    for (let char of s) {
        let ind = Math.abs(97 - char.codePointAt(0));
        let num = widths[ind];
